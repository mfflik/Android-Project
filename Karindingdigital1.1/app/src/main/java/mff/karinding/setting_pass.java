...
public class setting_pass extends AppCompatActivity implements MyPassCallback, View.OnClickListener,CompoundButton.OnCheckedChangeListener{
    MyPass myPass;
    Switch switchActive;
    ...
    void showDialogIndex(){
        ...
        AlertDialog dialogIndex = new AlertDialog.Builder(setting_pass.this)
